...
export const content: ContentData = {
  company: {
    name: "Granite Elite",
    logo: "/images/Advent/logo.png",
    phone: "+1 (555) 123-4567",
    email: "info@graniteelite.com",
    address: "123 Stone Street, Rock City, RC 12345",
    social: {
  ...
  landing: {
    ...
    process: {
      title: "Our Process",
      description: "From raw material to finished product, every step is handled with precision and care",
      image: "/images/Advent/IMG_2594.jpg",
      steps: [
        {
          title: "Raw Material Procurement",
          description: "Selecting the finest quality materials from trusted sources",
        ...
        },
        {
          ...
          longDescription: "Our manufacturing process combines traditional craftsmanship with modern technology. Each piece is cut, shaped, and finished with meticulous attention to detail. Our skilled artisans ensure that every surface is perfectly polished and every edge is precisely finished.",
          image: "/images/Advent/IMG_2599.jpg"
        },
        {
          title: "Internal Inspection",
          description: "Rigorous quality control standards",
          longDescription: "Every product undergoes thorough internal quality checks at multiple stages of production. Our quality control team inspects each piece for consistency in color, pattern, finish, and structural integrity. Only pieces that meet our strict standards move forward in the process.",
        ...
        },
        {
          ...
          longDescription: "We take great care in packaging and shipping our products. Each piece is carefully wrapped and secured for transport. We work with reliable logistics partners to ensure safe and timely delivery to our customers, with real-time tracking and delivery updates.",
  ...
  process: {
    title: "Our Process",
    description: "Excellence in every step, from raw material to finished product",
    image: "/images/Advent/IMG_2594.jpg",
    steps: [
      {
        title: "Raw Material Procurement",
    ...
    projects: [
      {
        ...
        description: "Complete kitchen transformation with Baltic Brown granite",
      ...
      },
      {
        ...
        description: "High-traffic commercial space with durable granite surfaces",
