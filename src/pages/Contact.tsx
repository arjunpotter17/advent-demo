...
const Contact = () => {
    ...
    switch (name) {
      ...
      case 'phone':
        ...
        return !/^\d{10,}$/.test(value.replace(/[\s-]/g, '')) 
          ? 'Phone number must contain only numbers (minimum 10 digits)' 
          : undefined;
      case 'message':
  ...
  // Update input className to use border-bottom only and add transitions
  const inputClassName = (fieldName: keyof FormData) => `
    block w-full border-0 border-b-2 px-0 pt-2 pb-1.5
    bg-transparent
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-[50px]">
      {/* Hero Section */}
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className={inputWrapperClassName}>
                ...
                <div className="h-5 mt-1 relative">
                  <motion.div
                    ...
                    animate={{ 
                      opacity: formErrors.name ? 1 : 0,
                      y: formErrors.name ? 0 : -10 
                    }}
              ...
              <div className={inputWrapperClassName}>
                ...
                <div className="h-5 mt-1 relative">
                  <motion.div
                    initial={{ opacity: 0, y: -10 }}
                    animate={{ 
                      opacity: formErrors.message ? 1 : 0,
                      y: formErrors.message ? 0 : -10 
                    }}
                    transition={{ duration: 0.2, ease: "easeInOut" }}
                    className="absolute top-0 left-0 w-full"
                  >
              ...
              <motion.button
                ...
                initial={{ backgroundColor: '#94a3b8' }}
                animate={{
                ...
                className={`w-full py-3 px-4 border border-transparent rounded-md shadow-sm text-white
                  focus:outline-none
                  ${(!isFormValid() || isSubmitting) ? 'opacity-75 cursor-not-allowed' : 'hover:bg-blue-700'}`}
              >
