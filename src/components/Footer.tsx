        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <Image
              ...
              className="mb-4"
            />
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">{company.address}</p>
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-2">{company.phone}</p>
            <p className="text-gray-600 dark:text-gray-400 text-sm">{company.email}</p>
          </div>
